...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-1">
        <div>
            ...
            <p class="content-sub-title">Manajemen data gejala penyakit</p>
        </div>
    ...
    <div class="card-content">
        <form method="post" id="form-data">
            ...
            <div class="w-100 mb-3">
                <label for="name" class="form-label input-label">Nama Gejala <span
                        class="color-danger">*</span></label>
                <input type="text" placeholder="nama gejala" class="text-input" id="name"
